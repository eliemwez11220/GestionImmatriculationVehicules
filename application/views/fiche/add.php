    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Fiche Add</h3>
            </div>
          	...
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="plaque_vehicule_sid" class="form-control">
								...
								{
									$selected = ($vehicule['vehicule_id'] == $this->input->post('plaque_vehicule_sid')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="statut_declaration" class="form-control">
								...
								{
									$selected = ($value == $this->input->post('statut_declaration')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="date_validation" value="<?php echo $this->input->post('date_validation'); ?>" class="has-datetimepicker form-control" id="date_validation" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="nombre_kilometrage" class="control-label">Nombre Kilometrage</label>
						<div class="form-group">
							<input type="text" name="nombre_kilometrage" value="<?php echo $this->input->post('nombre_kilometrage'); ?>" class="form-control" id="nombre_kilometrage" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="date_entree_vehicule" class="control-label">Date Entree Vehicule</label>
						<div class="form-group">
							<input type="text" name="date_entree_vehicule" value="<?php echo $this->input->post('date_entree_vehicule'); ?>" class="has-datepicker form-control" id="date_entree_vehicule" />
						</div>
					</div>
					<div class="col-md-6">
